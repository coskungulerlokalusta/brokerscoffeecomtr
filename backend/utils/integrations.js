...
const DEFAULTS = {
  ...
  multinet: { enabled: false, authorizationToken: '', merchantId: '', terminalId: '', saltKey: '', defaultProductId: '', environment: 'test' },
...
const SECRET_FIELDS = {
  ...
  multinet: ['authorizationToken', 'saltKey'],
  pluxee: ['apiKey'],
  ticket: ['apiKey'],
  metropol: ['apiKey'],
};
...
const ENV_MAP = {
  ...
  multinet: { authorizationToken: 'MULTINET_AUTH_TOKEN', merchantId: 'MULTINET_MERCHANT_ID', terminalId: 'MULTINET_TERMINAL_ID', saltKey: 'MULTINET_SALT_KEY', defaultProductId: 'MULTINET_PRODUCT_ID' },
